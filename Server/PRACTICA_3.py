...
DIST_OBSTACULO = 30.0    # Distancia (cm) para parada de emergencia por obstáculo
...
BOLA_CENTRADA = 0.10     # |error| por debajo → centrada (avanza recto / puede recoger)
...
VEL_RETROCESO_FINO = 1000 # Velocidad de retroceso LENTO al reposicionar bola muy cerca (no el de seguridad)
