"""
Ver_YOLO_en_vivo.py — Visualización en tiempo real de las detecciones YOLO.

Usa el cliente de Freenove (app de Windows) para ver el streaming de vídeo
con los bounding boxes dibujados encima.

Instrucciones:
  1. Copiar best.onnx a la carpeta Server/
  2. Ejecutar: sudo python Ver_YOLO_en_vivo.py
...
def main():
    print("==============================================")
    print(" VISUALIZACIÓN YOLO EN TIEMPO REAL")
    print("==============================================")
